...
def main():
    ...
    To build noarch packages, add this to the build section of the meta.yaml
    ...
    print(colored("Package  : ","magenta") + colored( str(pkgpth)  , "blue"))
    ...
    print('''
     ...
     <_/_\_/_\_/_\_/_\_/_\_/_______/   \   zzzzz !''')
